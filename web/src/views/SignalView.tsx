...
import { CrossCheck, HazardClasses, Rankings, Recommendations } from "../SignalExtras";
...
export default function SignalView() {
  ...
  return (
    <div className="view">
      ...
      <div className="section-title">
        <h2>Does the finding hold up?</h2>
        <p>Two more ways of looking at the same records, including where they disagree.</p>
      </div>
      <CrossCheck />
      <Rankings />
